...
if __name__ == "__main__":
    ...
    # print('\nUS place_order:')
    print(trade_context.place_order(price="3.55", qty=1, strcode='US.MIN', orderside=0, ordertype=2, envtype=1, order_deal_push=True, price_mode=PriceRegularMode.LOWER))
    # '''
